...
# Используем переменные окружения для Redis на Render
CELERY_BROKER_URL: str = os.getenv('REDIS_URL', 'redis://127.0.0.1:6379')
CELERY_RESULT_BACKEND: str = os.getenv('REDIS_URL', 'redis://127.0.0.1:6379')
...
# Используем переменную окружения для Redis
CACHES = {
    'default': {
...
# Настраиваем базу данных через DATABASE_URL
DATABASES = {
